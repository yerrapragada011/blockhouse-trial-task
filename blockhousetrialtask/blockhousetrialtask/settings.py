"""
Django settings for blockhousetrialtask project.
...
SECRET_KEY = 'w3$9#%*a0qzjccn_#gf$(z_ozwy&glzdi4$+2bot2srpij=h+h'
...
INSTALLED_APPS = [
    ...
    'fetchfinancialdata.apps.FetchfinancialdataConfig',
]
